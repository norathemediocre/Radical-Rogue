...
export function initAbilities() {
  allAbilities.push(
    ...
    new Ability(Abilities.FLAMING_SOUL, 6)
      .attr(IncrementMovePriorityAbAttr, (pokemon, move) => pokemon.getHpRatio() === 1 && move.type === Type.FIRE),
      new Ability(Abilities.FELINE_PROWESS, 9)
